package org.iop.client.version_1.network_calls;
...
public class NetworkClientCommunicationCall implements NetworkClientCall {
    ...
    @Override
    public Object sendSyncRequestPackageMessage(NetworkServiceMessage packageContent) throws CantSendMessageException {
        //todo: improve this
        return connection.sendSyncPackageMessage(
                packageContent,
                networkServiceType,
                profile.getIdentityPublicKey(),
